			...
			<div id="joinField">
				<div class="id_area">
					...
					<div class="failSuc_notice">
						...
						<span v-else-if="flg_id_condition" class="fail">영어랑 숫자만 사용하세요.</span>
...
var app = new Vue({ 
    ...
    , methods: {
    	...
    	, duplicate_id : function() {
    		...
    		var engNum = /^[a-zA-Z0-9]*$/;
       		...
       		$.ajax({
   	            ...
   	            success : function(data) {  
   	            	if(self.id != ''){
   	            		if(engNum.test(self.id)){
   	            			if(data.dup == "ok") {
   	   	            			self.flg_id_fail = false;
   	   	            			self.flg_id_success = true;
   	   	            			self.flg_id_condition = false;
   	       	             	}
   	   	            		if (data.dup == "no") {
	    ...
	    , check_essential:function() {
			...
			const regSpe = /[`~!@#$%^&*|\\\'\";:\/?]/gi;
			if (self.pw != ''){
					console.log(regSpe.test(self.pw));
