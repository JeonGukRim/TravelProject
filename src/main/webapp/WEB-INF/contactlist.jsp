...
<body>
	...
	<div class="container">
		...
		<div id="smallCategroy">
			<span class="small_categoryadmin">문의내역</span> <span
				class="detail_smallCategroy"
				onclick="location.href='creatcontact.do'">문의하기 ▶</span>
		</div>
		<!-- 메인컨테이너 -->
		<div id="mainField">
...
<script type="text/javascript">
	...
	var contactlist_jsp = new Vue({
		...
		methods : {
			...
			fnRemove : function() {
				var self = this;
				var nparmap = {qNo : self.selectedItemList.qNo,mId : self.userId};
				$.ajax({
					url : "/delcontact.dox",
					dataType : "json",
					type : "POST",
			...
			fnView : function(item) {
				var self = this;
				self.pageChange("./selectcontact.do", {
					qNo : item.qNo
				});
			}
		},
